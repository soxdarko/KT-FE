    ...
    const addServiceToManyHandler = () => {
        const api = saveServicesToManyEmployees(serviceData)
            .then(() => {
                ...
                props.setDisplayAddServicesForm(
                    props.isSetupGuide ? 'block' : 'none',
                );
            })
            .catch((err) => {
    ...
    return (
        <>
            ...
            >
                ...
                <EmployeesPicker
                    ...
                    selectedServiceProvider={
                        props.servicesFormInput.serviceProviderId.value
                    }
            ...
            <WrappedButtonsMob
                ...
                save={onSubmit}
                isMobile={
                    isMobile && props.displayAddServicesForm === 'block'
                        ? true
                        : false
                }
