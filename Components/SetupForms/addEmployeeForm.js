...
const AddEmployeeForm = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        const formData = [
            {
                ...
                Phone: props.emplyeesFormInput.mobOperator.value + props.emplyeesFormInput.phone.value.trim(),
        ...
        if (!props.emplyeesFormInput.name.value.trim()) {
        ...
        } else if (props.emplyeesFormInput.password.value.trim() !== props.emplyeesFormInput.passConfirm.value.trim()) {
            ...
            inputValidityHandler('serviceProviderId', 'Morate izabrati salon za koji želite dodati radnika!');
        } else {
    ...
    return (
        <div style={{ display: props.displayAddEmployeeForm }} className={props.isSetupGuide ? '' : classes.AddForm}>
