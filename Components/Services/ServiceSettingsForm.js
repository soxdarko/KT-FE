          ...
          return (
            ...
            >
                ...
                <CheckBox
                  ...
                  onClick={() =>
                    props.setServiceSettingsData({
                      ...
                      ['favoriteService']:
                        !props.serviceSettingsData.favoriteService,
                    })
                  }
                />
                <p>Omiljena usluga?</p>
                ...
                <CheckBox
                  ...
                  onClick={() =>
                    props.setServiceSettingsData({
                      ...props.serviceSettingsData,
                      ['clientsSeePrice']:
                        !props.serviceSettingsData.clientsSeePrice,
                    })
                  }
                />
                ...
                <CheckBox
                  ...
                  onClick={() =>
                    props.setServiceSettingsData({
                      ...props.serviceSettingsData,
                      ['clientsSeeService']:
                        !props.serviceSettingsData.clientsSeeService,
                    })
                  }
                />
              ...
              <input
                ...
                onClick={() => props.saveSettingsServicesHandler()}
              />
            </div>
          )
        })}
