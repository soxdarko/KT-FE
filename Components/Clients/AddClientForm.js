...
const AddClientForm = (props) => {
    ...
    const onSubmit = (e) => {
        ...
        const formData = {
            ...
            Phone:
                props.formInput.mobOperator.value +
    ...
    return (
        <>
            ...
            >
				...
				{serviceProvidersPreview(props.serviceProviderData)}
                    ...
                    <Input
                        ...
                        color="red"
                        className={
                            isMobile ? classes.ForwardMob : classes.Forward
                        }
                        onClick={() => stopEdit()}
                    />
                </div>
            ...
            <WrappedButtonsMob
                ...
                save={onSubmit}
                isMobile={props.displayWrappedButtonsMob(
                    props.displayAddClientForm,
                )}
                displayForward="none"
                displaySave="block"
                displayAdd="none"
