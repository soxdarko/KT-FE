...
const Index = () => {
    ...
    const Authentification = (
        <>
            ...
            <div
                className={
                    isMobile ? classes.TabContainerMob : classes.TabContainer
                }
    ...
    useEffect(() => {
        ...
        if (
            (userStatus.guideStatus !== 'WorkingHours' &&
                userStatus.userRole === 'Company') ||
            ...
            >
                ...
                <AuthButton
                    ...
                    diplayBackdrop={
                        displayLogin === 'block'
                            ? 'block'
                            : displayRegServProv === 'block'
                            ? 'block'
                            : 'none'
                    }
                />
                {/* <button onClick={() => console.log(authenticate)}></button> */}{' '}
                {/* test za redux */}
                <Footer />
            </Layout>
        </>
